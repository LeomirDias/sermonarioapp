...
export default function SermonBuilder({ user, email }: SermonBuilderProps) {
    ...
    const updateMainPoint = (index: number, value: string) => {
        updateSermonData({
            mainPoints: sermonData.mainPoints.map((point, i) => i === index ? value : point)
        })
    }
    ...
    const generateSermon = async () => {
        ...
        if (!sermonData.title || !sermonData.theme || !sermonData.mainVerse || !sermonData.verseText || !sermonData.objective) {
            setGenerationError("Por favor, preencha todos os campos obrigatórios: Título, Tema, Versículo Principal, Texto do Versículo e Objetivo.")
            return
        }
        ...
        try {
            ...
            const mappedData = {
                ...
                introduction: {
                    greeting: generatedSermon.estrutura?.introducao?.abertura || sermonData.introduction.greeting,
                    context: generatedSermon.estrutura?.introducao?.contexto || sermonData.introduction.context,
                    hook: generatedSermon.estrutura?.introducao?.gancho || sermonData.introduction.hook
                },
                exposition: {
                    historicalContext: generatedSermon.estrutura?.exposicaoBiblica?.contextoHistorico || sermonData.exposition.historicalContext,
                    culturalContext: generatedSermon.estrutura?.exposicaoBiblica?.contextoCultural || sermonData.exposition.culturalContext,
                    textAnalysis: generatedSermon.estrutura?.exposicaoBiblica?.analiseTexto || sermonData.exposition.textAnalysis,
                    supportVerses: Array.isArray(generatedSermon.estrutura?.exposicaoBiblica?.versiculosApoio)
                ...
                application: {
                    ...
                    family: generatedSermon.estrutura?.aplicacaoPratica?.familia || sermonData.application.family,
                    church: generatedSermon.estrutura?.aplicacaoPratica?.igreja || sermonData.application.church,
                    society: generatedSermon.estrutura?.aplicacaoPratica?.sociedade || sermonData.application.society
                },
                conclusion: {
                    summary: generatedSermon.estrutura?.conclusao?.resumo || sermonData.conclusion.summary,
                    callToAction: generatedSermon.estrutura?.conclusao?.chamadaAcao || sermonData.conclusion.callToAction,
                    finalPrayer: generatedSermon.estrutura?.conclusao?.oracaoFinal || sermonData.conclusion.finalPrayer
                },
                notes: {
                    illustrations: generatedSermon.estrutura?.anotacoes?.ilustracoes || sermonData.notes.illustrations,
                    statistics: generatedSermon.estrutura?.anotacoes?.estatisticas || sermonData.notes.statistics,
                    quotes: generatedSermon.estrutura?.anotacoes?.citacoes || sermonData.notes.quotes,
                    general: generatedSermon.estrutura?.anotacoes?.observacoes || sermonData.notes.general
                }
            }
    ...
    return (
        <div className="min-h-screen bg-gray-50 py-4 relative">
            ...
            <div className="max-w-5xl mx-auto px-4 relative md:ml-100">
                ...
                <Card className="mb-6">
                    <CardHeader>
                        ...
                        <p className="text-sm text-gray-600 mt-1">
                            Preencha os campos abaixo e clique em &quot;Gerar Sermão&quot; para criar automaticamente a estrutura completa
                        </p>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <Input
                                    ...
                                    onChange={(e) => updateSermonData({ mainVerse: e.target.value })}
                            ...
                            <div>
                                ...
                                <Input
                                    ...
                                    onChange={(e) => updateSermonData({ verseText: e.target.value })}
                        ...
                        <div>
                            ...
                            <Textarea
                                ...
                                onChange={(e) => updateSermonData({ objective: e.target.value })}
                ...
                {!isGenerating && (sermonData.introduction.greeting || sermonData.exposition.historicalContext || sermonData.mainPoints[0]) && (
                    <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                        <div className="flex items-center">
                            <Sparkles className="h-5 w-5 text-blue-600 mr-2" />
                            <p className="text-sm text-blue-800">
                                <strong>Conteúdo gerado automaticamente:</strong> As seções abaixo foram preenchidas pela IA.
                                Você pode editar, adicionar ou remover qualquer conteúdo conforme necessário.
                            </p>
                        </div>
                    </div>
                )}
                ...
                {/* Seção de Introdução */}
                <Card className="mb-6">
                    <Collapsible open={!collapsedSections.introduction} onOpenChange={() => toggleSection('introduction')}>
                        <CollapsibleTrigger asChild>
                            <CardHeader className="cursor-pointer hover:bg-gray-50">
                                <CardTitle className="flex items-center justify-between">
                                    Introdução
                                    {collapsedSections.introduction ? <ChevronDown className="h-5 w-5" /> : <ChevronUp className="h-5 w-5" />}
                                </CardTitle>
                            </CardHeader>
                        </CollapsibleTrigger>
                        <CollapsibleContent>
                            <CardContent className="space-y-4">
                                <div>
                                    ...
                                    <Textarea
                                        ...
                                        onChange={(e) => updateSermonData({
                                            introduction: { ...sermonData.introduction, greeting: e.target.value }
                                        })}
                                ...
                                <div>
                                    ...
                                    <Textarea
                                        ...
                                        onChange={(e) => updateSermonData({
                                            introduction: { ...sermonData.introduction, context: e.target.value }
                                        })}
                                ...
                                <div>
                                    ...
                                    <Textarea
                                        ...
                                        onChange={(e) => updateSermonData({
                                            introduction: { ...sermonData.introduction, hook: e.target.value }
                                        })}
                ...
                <Card className="mb-6">
                    <Collapsible open={!collapsedSections.exposition} onOpenChange={() => toggleSection('exposition')}>
                        <CollapsibleTrigger asChild>
                            <CardHeader className="cursor-pointer hover:bg-gray-50">
                                <CardTitle className="flex items-center justify-between">
                                    Exposição Bíblica
                                    {collapsedSections.exposition ? <ChevronDown className="h-5 w-5" /> : <ChevronUp className="h-5 w-5" />}
                                </CardTitle>
                            </CardHeader>
                        </CollapsibleTrigger>
                        <CollapsibleContent>
                            <CardContent className="space-y-4">
                                <div>
                                    ...
                                    <Textarea
                                        ...
                                        onChange={(e) => updateSermonData({
                                            exposition: { ...sermonData.exposition, historicalContext: e.target.value }
                                        })}
                                ...
                                <div>
                                    ...
                                    <Textarea
                                        ...
                                        onChange={(e) => updateSermonData({
                                            exposition: { ...sermonData.exposition, culturalContext: e.target.value }
                                        })}
                                ...
                                <div>
                                    ...
                                    <Textarea
                                        ...
                                        onChange={(e) => updateSermonData({
                                            exposition: { ...sermonData.exposition, textAnalysis: e.target.value }
                                        })}
                                ...
                                <div>
                                    ...
                                    <Textarea
                                        ...
                                        onChange={(e) => updateSermonData({
                                            exposition: { ...sermonData.exposition, supportVerses: e.target.value }
                                        })}
                ...
                <Card className="mb-6">
                    <Collapsible open={!collapsedSections.mainPoints} onOpenChange={() => toggleSection('mainPoints')}>
                        <CollapsibleTrigger asChild>
                            <CardHeader className="cursor-pointer hover:bg-gray-50">
                                <CardTitle className="flex items-center justify-between">
                                    Pontos Principais
                                    {collapsedSections.mainPoints ? <ChevronDown className="h-5 w-5" /> : <ChevronUp className="h-5 w-5" />}
                                </CardTitle>
                            </CardHeader>
                        </CollapsibleTrigger>
                        <CollapsibleContent>
                ...
                <Card className="mb-6">
                    <Collapsible open={!collapsedSections.application} onOpenChange={() => toggleSection('application')}>
                        <CollapsibleTrigger asChild>
                            <CardHeader className="cursor-pointer hover:bg-gray-50">
                                <CardTitle className="flex items-center justify-between">
                                    Aplicação Prática
                                    {collapsedSections.application ? <ChevronDown className="h-5 w-5" /> : <ChevronUp className="h-5 w-5" />}
                                </CardTitle>
                            </CardHeader>
                        </CollapsibleTrigger>
                        <CollapsibleContent>
                            <CardContent className="space-y-4">
                                <div>
                                    ...
                                    <Textarea
                                        ...
                                        onChange={(e) => updateSermonData({
                                            application: { ...sermonData.application, personal: e.target.value }
                                        })}
                                ...
                                <div>
                                    ...
                                    <Textarea
                                        ...
                                        onChange={(e) => updateSermonData({
                                            application: { ...sermonData.application, family: e.target.value }
                                        })}
                                ...
                                <div>
                                    ...
                                    <Textarea
                                        ...
                                        onChange={(e) => updateSermonData({
                                            application: { ...sermonData.application, church: e.target.value }
                                        })}
                                ...
                                <div>
                                    ...
                                    <Textarea
                                        ...
                                        onChange={(e) => updateSermonData({
                                            application: { ...sermonData.application, society: e.target.value }
                                        })}
                ...
                {/* Seção de Conclusão */}
                <Card className="mb-6">
                    <Collapsible open={!collapsedSections.conclusion} onOpenChange={() => toggleSection('conclusion')}>
                        <CollapsibleTrigger asChild>
                            <CardHeader className="cursor-pointer hover:bg-gray-50">
                                <CardTitle className="flex items-center justify-between">
                                    Conclusão
                                    {collapsedSections.conclusion ? <ChevronDown className="h-5 w-5" /> : <ChevronUp className="h-5 w-5" />}
                                </CardTitle>
                            </CardHeader>
                        </CollapsibleTrigger>
                        <CollapsibleContent>
                            <CardContent className="space-y-4">
                                <div>
                                    ...
                                    <Textarea
                                        ...
                                        onChange={(e) => updateSermonData({
                                            conclusion: { ...sermonData.conclusion, summary: e.target.value }
                                        })}
                                ...
                                <div>
                                    ...
                                    <Textarea
                                        ...
                                        onChange={(e) => updateSermonData({
                                            conclusion: { ...sermonData.conclusion, callToAction: e.target.value }
                                        })}
                                ...
                                <div>
                                    ...
                                    <Textarea
                                        ...
                                        onChange={(e) => updateSermonData({
                                            conclusion: { ...sermonData.conclusion, finalPrayer: e.target.value }
                                        })}
                        ...
                        <CollapsibleTrigger asChild>
                            <CardHeader className="cursor-pointer hover:bg-gray-50">
                                <CardTitle className="flex items-center justify-between">
                                    ...
                                    {collapsedSections.notes ? <ChevronDown className="h-5 w-5" /> : <ChevronUp className="h-5 w-5" />}
                                </CardTitle>
                            </CardHeader>
                        </CollapsibleTrigger>
                        <CollapsibleContent>
                            <CardContent className="space-y-4">
                                <div>
                                    ...
                                    <Textarea
                                        ...
                                        onChange={(e) => updateSermonData({
                                            notes: { ...sermonData.notes, illustrations: e.target.value }
                                        })}
                                ...
                                <div>
                                    ...
                                    <Textarea
                                        ...
                                        onChange={(e) => updateSermonData({
                                            notes: { ...sermonData.notes, statistics: e.target.value }
                                        })}
